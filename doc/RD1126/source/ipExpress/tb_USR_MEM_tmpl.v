//Verilog testbench template generated by SCUBA Diamond_1.3_Production (92)
`timescale 1 ns / 1 ps
module tb;
    reg [7:0] DataInA = 8'b0;
    reg [7:0] DataInB = 8'b0;
    reg [4:0] AddressA = 5'b0;
    reg [4:0] AddressB = 5'b0;
    reg ClockA = 0;
    reg ClockB = 0;
    reg ClockEnA = 0;
    reg ClockEnB = 0;
    ...
    USR_MEM u1 (.DataInA(DataInA), .DataInB(DataInB), .AddressA(AddressA), 
    ...
    begin
      ...
      @(WrA == 1'b1);
      @(WrA == 1'b0);
      for (i10 = 0; i10 < 35; i10 = i10 + 1) begin
        @(posedge ClockA);
      end
      for (i10 = 0; i10 < 35; i10 = i10 + 1) begin
        @(posedge ClockB);
