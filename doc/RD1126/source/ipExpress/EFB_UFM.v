...
/* Module Version: 1.0 */
/* C:\lscc\diamond\1.4\ispfpga\bin\nt\scuba.exe -w -n EFB_UFM -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 2.08 -ufm -ufm_ebr 0 -mem_size 511 -ufm_0 -dev 1200 -e  */
/* Thu Mar 22 22:48:24 2012 */


`timescale 1 ns / 1 ps
module EFB_UFM (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, wbc_ufm_irq);
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
