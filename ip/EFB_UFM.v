...
/* Module Version: 1.2 */
/* C:\lscc\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n EFB_UFM -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 2.08 -ufm -ufm_ebr 1535 -mem_size 511 -ufm_0 -wb -dev 7000  */
/* Sat Jan 31 15:37:16 2015 */


`timescale 1 ns / 1 ps
module EFB_UFM (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, 
    wb_adr_i, wb_dat_i, wb_dat_o, wb_ack_o, wbc_ufm_irq)/* synthesis NGD_DRC_MASK=1 */;
    input wire wb_clk_i;
    input wire wb_rst_i;
    input wire wb_cyc_i;
    input wire wb_stb_i;
    ...
    defparam EFBInst_0.UFM_INIT_START_PAGE = 1535 ;
